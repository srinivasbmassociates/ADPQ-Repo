...
var specialKeys = new Array();
		...
		function  checklogin()
		{
		    /* var username = document.forms["loginform"]["username"].value;
	         var passwrd = document.forms["loginform"]["passwrd"].value;
                          ...
                          <select id='feedbacktype' name='feedbacktype' class="form-control" onchange="changeFunc();" required="required">
                            ...
                            <option value='1' >Feedback about your registration</option>
            							  ...
            							  <option value='3' >About search for care home</option>
            							   <option value='4' >About your communication with Case Worker</option>
                      ...
                      <div class="modal-dialog modal-sm">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <input type="text" id="Db"  name="Db" required="required" placeholder='Enter Date Of Birth' class="form-control col-md-12 col-xs-12">(YYYY-MM-DD)
                          </div>
                        </div>
                       <div class="form-group">
      ...
      $(document).ready(function() {
        ...
        $('.stars').on('starrr:change', function (e, value) {
          $('.stars-count').html(value);
		   $("#rating").val(value);
		  //$('.ratingbox').html(value);
		  //document.getElementById("ratingbox").value = value;
		 // alert(value);exit;
        });
